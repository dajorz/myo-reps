...
The app SHALL render a horizontal tab bar at the top of the screen with two tabs: "Myo-Reps" and "Timer". The active tab SHALL be visually highlighted. Tab labels SHALL use translated strings via `t()`.
